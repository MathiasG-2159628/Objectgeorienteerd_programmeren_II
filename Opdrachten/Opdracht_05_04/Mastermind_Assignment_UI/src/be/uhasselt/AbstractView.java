...
public abstract class AbstractView implements View, Observer {
    ...
    public Controller getController() {
        ...
        if (mController == null) {
            ...
            // the be.uhasselt.AbstractView subclass so that it returns the appropriate
     ...
     * Subclasses of be.uhasselt.AbstractView will provide a concrete implementation for
     * this method.
     */
    @Override
